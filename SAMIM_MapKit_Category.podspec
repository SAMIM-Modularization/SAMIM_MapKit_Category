...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of SAMIM_MapKit_Category.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/811528603@qq.com/SAMIM_MapKit_Category'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '811528603@qq.com' => '811528603@qq.com' }
  s.source           = { :git => 'https://github.com/811528603@qq.com/SAMIM_MapKit_Category.git', :tag => s.version.to_s }
